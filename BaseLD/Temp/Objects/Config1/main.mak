...
export AS_PROJECT_PATH := D:/PLC/BaseLD
export AS_PROJECT_NAME := BaseLD
export AS_SYSTEM_PATH := C:/BrAutomation/AS/System
export AS_VC_PATH := C:/BrAutomation/AS47/AS/VC
export AS_TEMP_PATH := D:/PLC/BaseLD/Temp
export AS_CONFIGURATION := Config1
export AS_BINARIES_PATH := D:/PLC/BaseLD/Binaries
...
export WIN32_AS_PROJECT_PATH := "D:\PLC\BaseLD"
export WIN32_AS_SYSTEM_PATH := "C:\BrAutomation\AS\System"
export WIN32_AS_VC_PATH := "C:\BrAutomation\AS47\AS\VC"
export WIN32_AS_TEMP_PATH := "D:\PLC\BaseLD\Temp"
export WIN32_AS_BINARIES_PATH := "D:\PLC\BaseLD\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/BaseLD.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'BuildAndCreateCompactFlash'   
